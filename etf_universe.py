...
# 名称关键词 → 行业分类
_CATS = [
    (["半导体", "芯片", "集成电路", "存储", "封测"],         "科技"),
    (["5G", "通信", "人工智能", "AI", "云计算", "数字经济",
      "互联网", "软件", "信息技术", "大数据"],               "科技"),
    (["新能源车", "电动车", "汽车"],                          "新能源"),
    (["新能源", "光伏", "储能", "风电", "碳中和", "氢能"],    "新能源"),
    (["医药", "医疗", "生物", "CXO", "创新药", "疫苗",
      "基因", "器械", "健康"],                               "医药"),
    (["银行", "证券", "金融", "保险", "券商"],                "金融"),
    (["黄金", "有色", "铜", "铝", "锂", "煤炭", "钢铁",
      "化工", "稀土", "资源"],                               "商品"),
    (["军工", "国防", "航空", "航天", "兵器"],               "军工"),
    (["消费", "食品", "饮料", "白酒", "家电", "零售", "酒"], "消费"),
    (["红利", "央企", "国企", "价值", "低波", "股息"],        "红利"),
    (["沪深300", "上证50", "中证500", "中证1000", "中证2000",
      "创业板", "科创50", "科创板", "北证", "全指"],           "宽基"),
    (["沪深", "中证", "上证", "深证"],                        "宽基"),
    (["恒生", "港股", "香港", "中概互联"],                   "港股"),
    (["纳指", "标普", "美国", "日经", "德国", "越南",
      "印度", "海外", "NASDAQ"],                             "海外"),
    (["REITs", "基础设施", "产业园", "仓储物流"],            "REITs"),
]
